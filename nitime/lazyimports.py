...
if "sphinx" in sys.modules:
    class LazyImport(object):
        ...
        mlab method or try to do tab completion or introspection on mlab in
        IPython. 
        ...
        """
        def __init__(self,x):
            __import__(x) and sys.modules[x]
else:
    # This flag only has affect on this module's import, and if it is set to
    # True, LazyImports are performed immediately. Note: this flag is currently
    # here only for debugging purposes and must be set directly in the source
    # code, since nitime.lazy imports this module, and nitime.lazy is used
    # throughout nitime, importing nitime will import this module.
